...
const Profile = () => {
    ...
    const { name, mobile, email, img } = userdetail;
                ...
                <div className='py-16 w-full shadow-lg border border-accent rounded-md px-8 '>
                    ...
                    <div className=' lg:pt-4 flex_profile'>
                        <div className='flex flex-col items-start profile '>
                            ...
                            <div className='md:text-lg text-base border border-base-300  border rounded-lg -mt-3 z-0 py-2 px-5 w-full w-full text-start font-base text-base-300'>{name}</div>
                            {/* ----code for Email -----*/}
                            <div className=' bg-base-100 text-primary z-10 ml-4 px-1 mt-4'>Email</div>
                            <div className='md:text-lg text-base border border-base-300  border rounded-lg -mt-3 z-0 py-2 px-5 w-full w-full text-start font-base text-base-300'>{email}</div>
                            {/* ----code for Phone -----*/}
                            <div className=' bg-base-100 text-primary z-10 ml-4 px-1 mt-4'>Mobile</div>
                            <div className='md:text-lg text-base border border-base-300  border rounded-lg -mt-3 z-0 py-2 px-5 w-full w-full text-start font-base text-base-300'>{mobile}</div>
